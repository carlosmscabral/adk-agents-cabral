...
app = FastAPI(title="Visual Pizza Agent Backend")
...
runner = Runner(app_name="visual_pizza_agent", agent=root_agent, session_service=session_service)
...
async def websocket_endpoint(websocket: WebSocket, user_id: str, session_id: str):
    ...
    session = await session_service.get_session(
        app_name="visual_pizza_agent", user_id=user_id, session_id=session_id
    )
    if not session:
