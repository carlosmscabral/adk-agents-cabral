...
| **A2A Hybrid Artifact Transfer (pt-BR)** | Demonstrates a **hybrid architecture** (Agent Runtime + Cloud Run) for transferring heavy PDF files between ADK agents using the A2A protocol and shared GCS artifacts, optimized for Gemini Enterprise. | [a2a-demo-ptbr](./a2a-demo-ptbr/) |
## License
